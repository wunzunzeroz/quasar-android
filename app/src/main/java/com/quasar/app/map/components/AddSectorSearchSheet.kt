...
fun AddSectorSearchSheet(
    ...
    var legCount by remember { mutableIntStateOf(9) }
    ...
    Column(
        ...
        Button(onClick = {
            val search = SearchPattern.createSectorSearch(
                datum = Position.fromPoint(datum),
                initialLegDirection = Heading(trackDirection),
...
fun AddSectorSearchSheetPreview() {
    AddSectorSearchSheet(datum = Point.fromLngLat(0.0, 0.0), onCreatePattern = {})
}